...
if (result.numTotalTestSuites !== 14 || result.numTotalTests !== 1712) {
  throw new Error(
    `unexpected Jest coverage: expected 14 suites/1712 tests, found ${result.numTotalTestSuites} suites/${result.numTotalTests} tests`,
  );
}
if (
  result.numPassedTestSuites !== 14 ||
  result.numPendingTestSuites !== 0 ||
  result.numPassedTests !== 1712 ||
...
console.log("Jest count verified: all 14 suites and all 1712 tests passed with no skipped/todo work");

...
if (result.numTotalTestSuites !== 13 || result.numTotalTests !== 1696) {
  throw new Error(
    `unexpected Jest coverage: expected 13 suites/1696 tests, found ${result.numTotalTestSuites} suites/${result.numTotalTests} tests`,
  );
}
if (
  result.numPassedTestSuites !== 13 ||
  result.numPendingTestSuites !== 0 ||
  result.numPassedTests !== 1696 ||
...
console.log("Jest count verified: all 13 suites and all 1696 tests passed with no skipped/todo work");
